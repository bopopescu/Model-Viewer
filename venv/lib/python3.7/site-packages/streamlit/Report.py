...
class Report(object):
    ...
    the two ReportQueues (main_queue and browser_queue) that are used
    ...
    def __init__(self, script_path, command_line):
        ...
        # The main queue contains all messages that comprise the report.
        # If the user chooses to share a saved version of the report,
        # we serialize the contents of the main queue.
        self._main_queue = ReportQueue()
    ...
    def get_debug(self):
        return {"main queue": self._main_queue.get_debug()}

    def enqueue(self, msg):
        self._main_queue.enqueue(msg)
        self._browser_queue.enqueue(msg)

    def clear(self):
        # Main_queue retains its initial message; browser_queue is
        # completely cleared.
        initial_msg = self._main_queue.get_initial_msg()
        self._main_queue.clear()
        if initial_msg:
            self._main_queue.enqueue(initial_msg)
    ...
    def flush_browser_queue(self):
        ...
        This doesn't affect the main_queue.
